...
describe "ReminderSpec" do
  let(:call) { Ical::Reminder.post({passcode: "12345", date: DateTime.now + 2.days, utc_date: DateTime.now.utc + 2.days, timezone: "America/Chicago", guest: "John Doe"}, "test@email.com") }
  describe "#post" do
